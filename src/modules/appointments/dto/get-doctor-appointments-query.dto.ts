...
export class GetDoctorAppointmentsQueryDto {
  @ApiPropertyOptional({ description: 'Filter by user/patient ID' })
  @IsOptional()
  @IsUUID()
  userId?: string;
  ...
  @ApiPropertyOptional({ description: 'Sort by field, e.g., createdAt' })
  @IsOptional()
  sortBy?: string;

  @ApiPropertyOptional({ description: 'Sort order direction', example: 'ASC' })
  @IsOptional()
